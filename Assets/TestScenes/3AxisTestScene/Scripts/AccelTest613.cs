...
public class AccelTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        importPattern("rocking.csv", "rocking");
        importPattern("stationary.csv", "stationary");
        importPattern("flip.csv", "flip");
        importPattern("counterClockwiseVerticalCircle.csv", "LVcircle");
        importPattern("clockwiseVerticalCircle.csv", "RVcircle");
        importPattern("upsideDownStationary.csv", "upside down stationary");
        importPattern("counterClockwiseHorizontalCircle.csv", "LHcircle");
        importPattern("clockwiseHorizontalCircle.csv", "RHcircle");
        importPattern("leftRight.csv", "left right");
        importPattern("whale.csv", "whale");
    }
